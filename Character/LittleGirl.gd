...
var _droped_box_path = "res://Object/DroppedBoxNormal.tscn"
...
func chat(source_position, dialog_box):
	if not _found_first_note:
		...
		yield(dialog_box, "break_ended")
		dialog_box.hide_box()
		dialog_box.append_text("???: Where... where did you find it?[break]", 100)
		yield(dialog_box, "break_ended")
		dialog_box.hide_box()
		dialog_box.append_text("Kyoko: Umm, somewhere around the corner[break]", 100)
		yield(dialog_box, "break_ended")
		dialog_box.hide_box()
		dialog_box.append_text("???: hnggg[break]", 100)
		yield(dialog_box, "break_ended")
		dialog_box.hide_box()
		dialog_box.append_text("???: *sob*, thank you, Miss, uhhh...[break]", 100)
		yield(dialog_box, "break_ended")
		dialog_box.hide_box()
...
#		_anim_player.play("Normal")
		...
		yield(dialog_box, "break_ended")
		dialog_box.hide_box()
		dialog_box.append_text("Hikari: My lyric note. I need that for tomorrow's concert[break]", 100)
		yield(dialog_box, "break_ended")
		dialog_box.hide_box()
