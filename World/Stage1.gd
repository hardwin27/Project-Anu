...
func _on_NoticingTheGirl_body_entered(body):
	...
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Kyoko: WHO'S THERE?[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("???: ...*sobs*[break]", 100)
	yield(_dialog_box, "break_ended")
...
func _on_WhereAreWe_body_entered(body):
	...
	little_girl.set_global_position(_where_are_we.get_global_position())
...
func _on_GuardianChamber_body_entered(body):
	body.set_current_state("ON_CUTSCENE")
	body._anim_player.play("Idle")
#	_anim_player.play("GuardianChamber")
	var little_girl = load(_little_girl_path).instance()
	_guardian_chamber.add_child(little_girl)
	little_girl.set_global_position(_guardian_chamber.get_global_position())
	little_girl.set_npc_direction(body.get_global_position())
	...
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	# ??? Does it angry animation
	_dialog_box.append_text("Hikari: *crying* ...Kyoko...[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Kyoko: It's okay Hikari, I'll go talk to him[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Hikari: ...Kyoko...[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Hikari: But, you look scared...[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Kyoko: ...[break]", 100)
	yield(_dialog_box, "break_ended")
	...
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Kyoko: You see, when you turn into an adult, sometimes you need to overcome your fear..[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Kyoko: So don't worry, okay~[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	# A P P R O A C H I N G
	_dialog_box.append_text("???: RAARRRRGGGHHHH[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	...
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Giovanni: What are you doing here, O Little Failure?[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	...
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Kyoko: I said I saw her lyrics![break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	...
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Giovanni: Look how scare she is...[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Giovanni: If I let you two go, the same thing will happen again[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Giovanni: ...or should I let that happen?[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
	_dialog_box.append_text("Giovanni: So that she will scared of stage FOREVER[break]", 100)
	yield(_dialog_box, "break_ended")
	_dialog_box.hide_box()
